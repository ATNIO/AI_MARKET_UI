            ...
            <div class="search">
                ...
                <div class="search-select" v-if="searchShow">
                    ...
                    <transition-group name="itemfade" tag="ul" mode="out-in" v-cloak>
                        <li v-for="(value,index) in searchResult" :class="{selectback:index==now}" class="search-select-option" @mouseover="selectHover(index)" @click="selectClick(value)" :key="index">
                            <div class="logo-tag">
